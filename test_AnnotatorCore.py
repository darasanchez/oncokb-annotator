...
def conversion():
    ...
    assert conversion('Ly s Lys Th r Thr X X As p Asp') == 'Ly s L Th r T X X As p D'
...
def replace_all():
    ...
    assert replace_all('Ly Lys Pr Pro Gln Glad Glue Ph PH Phe') == 'Ly K Pr P Q Glad Glue Ph PH F'
    assert replace_all(
